...
[Files]
Source: bin\Microsoft.VC80.CRT\*;                                 DestDir: {app}\application\plugins\Microsoft.VC80.CRT; Components: plugin_romloader_uart
Source: "bin\bootloader_uart.dll";                                DestDir: "{app}\application\plugins";   Components: plugin_romloader_uart
;Source: "bin\bootloader_uart.dll.manifest";                       DestDir: "{app}\application\plugins";   Components: plugin_romloader_uart
